...
(function(){
   ...
   var init = function() {
       ...
       const RNPostMessage =  function(message) {
       ...
       window.webViewBridge = {
           ...
           addNamedCallback: function(name, callback) { 
       ...
       window.document.addEventListener('message', function(e) {
           ...
           if (namedCallbacks[message.name] && message.args){
               namedCallbacks[message.name].apply(null, message.args);
           }
       });
   };
